...
public final class PentagonLayout implements BoardLayout {
	...
	public List<BoardNode> buildNodes() {
		...
		// forward connection
	    start.addNext(n00);  n00.addNext(n01);  n01.addNext(n02);  n02.addNext(n03);   n03.addNext(f0);
	    ...
	    c.addNext(s30);   s30.addNext(s31);  s31.addNext(f3);
	    c.addNext(s40);   s40.addNext(s41);  s41.addNext(start);
	    
	    f2.addNext(n30);  n30.addNext(n31);  n31.addNext(n32);  n32.addNext(n33);  n33.addNext(f3);
	    f3.addNext(n40);  n40.addNext(n41);  n41.addNext(n42);  n42.addNext(n43);  n43.addNext(start);
		...
		c.addPrev(s21);  s21.addPrev(s20);  s20.addPrev(f2);
		s30.addPrev(c);  s31.addPrev(s30);  f3.addPrev(s31);
		s40.addPrev(c);  s41.addPrev(s40);  start.addPrev(s41);
		
		n30.addPrev(f2);  n31.addPrev(n30);  n32.addPrev(n31);  n33.addPrev(n32);  f3.addPrev(n33);
		n40.addPrev(f3);  n41.addPrev(n40);  n42.addPrev(n41);  n43.addPrev(n42);  start.addPrev(n43);
